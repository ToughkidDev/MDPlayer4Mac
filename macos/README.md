...
## 현재 상태 (2026-08-20, 음악 파일 포맷 13개 지원 + SN76489/YM2612 칩 채널 표시계 실기 검증 완료 + 남은 모든 칩 표시계 순차 구현 진행 중 — YM2151/AY8910/S5B/YM2413/YM3526/YM3812/Y8950/YMF262/YMF278B/YM2203/YM2608/YM2609/YM2610/YMF271/NESDMC/FDS/MMC5/VRC6/VRC7/N106/DMG/HuC6280/K051649/C140 완료 — NES 계열 + WF 계열 전체 완료, PCM 계열 착수, 실기 검증 대기)
...
### 🚧 칩 채널 표시계(visualizer) — SN76489/YM2612 실기 검증 완료, 남은 ~19개 칩 순차 구현 중 (YM2151/AY8910/S5B/YM2413/YM3526/YM3812/Y8950/YMF262/YMF278B/YM2203/YM2608/YM2609/YM2610/YMF271/NESDMC/FDS/MMC5/VRC6/VRC7/N106/DMG/HuC6280/K051649/C140 완료 — NES 계열 8종 + WF 계열 2종 전체 완료, PCM 계열 1/15 착수, 실기 검증 대기)
...
K051649(코나미 SCC, 5채널 웨이브테이블)/C140(코나미가 아니라 남코 System
2/21/NA-1용 24비트 PCM 샘플 재생 칩, 24채널)가 이번 라운드에서
완료됐습니다 — 이로써 NES 계열 8종(NESDMC/FDS/MMC5/VRC6/VRC7/N106/DMG +
이미 완료된 S5B(FME-7))과 WF 계열 2종(HuC6280/K051649)이 모두 끝났고,
PCM 계열(~15종) 이식도 C140으로 시작했습니다.
...
1. **남은 ~19개 칩 채널 표시계 계속 구현**: SN76489/YM2612/YM2151/AY8910/S5B/
   YM2413/YM3526/YM3812/Y8950/YMF262/YMF278B/YM2203/YM2608/YM2609/YM2610/
   YMF271/NESDMC/FDS/MMC5/VRC6/VRC7/N106/DMG/HuC6280/K051649/C140은
   완료했고(NES 계열 8종 + WF 계열 2종 전체 완료, PCM 계열 15종 중 C140
   완료), 이어서 나머지 칩들(PCM 계열 나머지 14종: C352/GA20/K053260/
   K054539/MegaCD/MpcmX68k/MultiPCM/OKIM6258/OKIM6295/PCM8/PWM/QSound/
   Rf5c68/SegaPCM, 그리고 YMZ280B — SAA1099는 범위 제외)을 순서대로 이식
   중입니다. 각 칩마다
   `DrawBuffXxx.cs`+
