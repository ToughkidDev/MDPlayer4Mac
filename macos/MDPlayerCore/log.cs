// macOS port: was `using MDPlayerx64.Properties;` / `using MDPlayer.Properties;` under
// an `#if X64` switch — resource strings are now plain constants in CompatShims.cs's
// Resources shim (see macos/README.md).
using System.Text;
